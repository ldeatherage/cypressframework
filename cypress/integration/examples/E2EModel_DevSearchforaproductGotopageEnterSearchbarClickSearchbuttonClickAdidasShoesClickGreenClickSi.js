...
describe("E2E Model", function() {
   it("DevSearchforaproductGotopageEnterSearchbarClickSearchbuttonClickAdidasShoesClickGreenClickSi", function() {
...
cy.get("LI[id='swatch-4-color']").click()

cy.get("LI[id='swatch-5-size']").click()
